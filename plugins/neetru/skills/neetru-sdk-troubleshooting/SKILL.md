...
| `Module not found: @neetru/sdk/next` `/server` `/middleware` | **Subpaths fantasma** (nunca existiram) | Use os reais: `/auth /catalog /entitlements /telemetry /usage /support /db /db/react /errors /checkout /react /webhooks /notifications /mocks` |
